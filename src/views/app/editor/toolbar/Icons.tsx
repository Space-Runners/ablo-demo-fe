...
export const IconColorPicker = () => (
  ...
  >
    <path
      opacity="0.3"
      d="M11.3198 9.63374C12.4146 8.81147 13.7753 8.32422 15.2498 8.32422C18.8673 8.32422 21.7998 11.2568 21.7998 14.8742C21.7998 18.4917 18.8673 21.4242 15.2498 21.4242C13.7753 21.4242 12.4146 20.937 11.3198 20.1147C10.2251 20.937 8.86439 21.4242 7.38984 21.4242C3.77238 21.4242 0.839844 18.4917 0.839844 14.8742C0.839844 11.2568 3.77238 8.32422 7.38984 8.32422C8.86439 8.32422 10.2251 8.81147 11.3198 9.63374ZM13.0669 11.6049C13.6221 12.5671 13.9398 13.6835 13.9398 14.8742C13.9398 16.0649 13.6221 17.1813 13.0669 18.1435C13.7026 18.5693 14.4558 18.8042 15.2498 18.8042C17.4203 18.8042 19.1798 17.0447 19.1798 14.8742C19.1798 12.7038 17.4203 10.9442 15.2498 10.9442C14.4548 10.9442 13.7009 11.1806 13.0669 11.6049L13.0669 11.6049Z"
      fill="white"
    />
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M15.9511 2.38281C18.509 4.94075 18.509 9.08799 15.9511 11.6459C13.3932 14.2039 9.24591 14.2039 6.68798 11.6459C4.13005 9.08799 4.13005 4.94075 6.68798 2.38281C9.24591 -0.175129 13.3932 -0.175129 15.9511 2.38281Z"
      fill="white"
    />
  </Icon>
);
